...
export class ReportDocumentAddController extends ControllerBase {
  private temp = {
    style: require('../../../style/documentHandle/reportDocument/reportDocumentAdd.less')
  }
  constructor() {
    super()
  }
