...
export class ReportAddController extends ControllerBase {
  constructor() {
    super()
  }
  ...
  private dialogOption = {
    ...
    propsData: {
      ...
      reportTitle: '', //标题
      comments: '', //说明
      reportRouter: '/briefReport/informationReport'
    }
  }
  ...
  mounted() {
    this.$refs.reportAdd['style'].display = 'block'
    window.setTimeout(() => {
  ...
  closeDialogCall(infoId) {
    ...
    if (infoId != 'justclose') {
      this.$refs.reportAdd['style'].display = 'none'
